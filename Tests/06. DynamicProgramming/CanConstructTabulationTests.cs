...
namespace Tests
{
    public class CanConstructTabulationTests : BaseTests
    {
        public CanConstructTabulationTests(ITestOutputHelper output) : base(output)
        {
        }
        ...
        {
            var sut = new CanConstructTabulation();
