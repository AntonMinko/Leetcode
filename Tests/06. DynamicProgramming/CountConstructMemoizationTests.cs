...
namespace Tests
{
    public class CountConstructMemoizationTests : BaseTests
    {
        public CountConstructMemoizationTests(ITestOutputHelper output) : base(output)
        {
        }
        ...
        {
            var sut = new CountConstructMemoization();
